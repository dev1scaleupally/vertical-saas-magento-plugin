...
class Returnurl extends Action
{
    ...
    public function execute()
    {
        try {
            ...
            $this->curl->post('https://2559-103-108-5-228.ngrok-free.app/api/verify-auth-code', ['code' => $authCode]);
            ...
            $this->curl->post('https://2559-103-108-5-228.ngrok-free.app/api/verify-magento-token', [
